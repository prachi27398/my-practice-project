#prompt the user for movie preference
...
# combine booleans using logical opertors
...
#Recommanded Movie base on genre using conditional statements

if genre == "Action-Comedy":
    print("Recommanded movies: 'Rush Hour','Bad Boys','The Nice Guys'")
